                ...
                <Navbar.Brand className={`${classes.brand} brand`}>
                    <a href={"/"} exact={true}>
                        <div className={`${classes.logo} logo`} style={{ display: "flex", alignItems: "center" }}>
                            ...
                            <div>
                                <a href='/'>
                                    <img className={`${classes.bdcLogo} bdcLogo`} src="/assets/cdylogo.png" />
                                </a>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav style={{ marginLeft: 'auto'}}>
                        <Nav className={`${classes.links_top} col-md-auto links_top`}>
                            ...
                            <a href={"#steps-to-donate"} className="top_link m-lg-1 m-xl-2 p-lg-1 p-xl-2" activeClassName="active_top_link">Kernel Events</a>
                           
                            <a href={"#dos-and-donts"} className="top_link m-lg-1 m-xl-2 p-lg-1 p-xl-2" activeClassName="active_top_link">Speakers</a>
