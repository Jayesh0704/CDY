        ...
        <div className="container">
           <div className="row">
               <div className="footer-col" >
                   ...
                   <ul>
                       <li><a href="/">Home</a></li>
                       <li><a href="#steps-to-donate">Kernel Events</a></li>
                       <li><a href="#dos-and-donts">Speakers</a></li>
               ...
               <div className="image-col">
                <img src="/assets/cdylogo.png" alt="" className="image1" />
           ...
           <p align='center'>
               <a id='meet-dev' href='/developers'>Meet the Developer</a>
           </p>
           <p align="center">© 2023 NSS BITS PILANI. All Rights Reserved</p>
       </div>
   </footer>
