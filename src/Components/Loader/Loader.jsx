            ...
            <div className={`${classes.loaderWrapper} loaderWrapper container-fluid`}>
                ...
                <div className="logo">
                    <div className="logoComponent">
                        <img src='./assets/cdylogo.png' width={230} height={230}  style={{ borderRadius: '50%' }} alt='CDY Logo' />
                    </div>
                ...
                <div className="textAnim">
                    <animated.h2 style={textProps} className="loaderText">Conferencia De Youth</animated.h2>
                    <animated.h2 style={textProps} className="loaderText">Conferencia De Youth</animated.h2>
                </div>
            </div>
        </React.Fragment>
